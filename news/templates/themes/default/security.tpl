...
<form class="form-horizontal" action="${PHP_SELF}" method="post">
  <div class="control-group">
    <label for="current_password" class="control-label">${STR_CURRENT PASSWORD}:</label>
    <div class="controls">
      <input type="password" class="span3 input-xlarge focused" name="current_password" placeholder="${STR_CURRENT PASSWORD}">
    </div>
  </div>
  <div class="control-group">
